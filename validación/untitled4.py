...
y_predicho = ["dkws", "bcf", "sbub", "sbub", "lu", "tbf", "fddf", "twdf", "fdff", "tpf",
              "tpf", "sf", "tpf", "dkws", "abw", "bff", "bff", "bfb", "bcf", "bff",
              "bpf", "bpf", "bpf", "tpf", "dkws", "bcf", "tscc", "bcf", "bff", "bff"]
...
plt.title("Matriz de Confusión - DNN_av")
plt.show()