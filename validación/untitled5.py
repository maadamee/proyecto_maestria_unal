...
y_predicho = ["pc", "bcf", "sbut", "sbut", "lu", "tbf", "fddf", "twdf", "tdf", "tdf",
              "sbut", "sf", "sf", "pc", "adw", "bff", "bcf", "bff", "bcf", "bff",
              "bpf", "bpf", "sbub", "tpf", "tpf", "tdf", "tbf", "bff", "bff", "tff"]
...
plt.title("Matriz de Confusión - LSTM_af")
plt.show()